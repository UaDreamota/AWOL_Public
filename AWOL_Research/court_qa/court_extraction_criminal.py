...
# ---------------- CONFIG ----------------
INPUT_DIR = r"D:\Projects\GitRepositories\TheAWOLthing\AWOL_Research\data\awol_court\html"  # <- set your folder
OUTPUT_CSV = r"D:\Projects\GitRepositories\TheAWOLthing\AWOL_Research\court_qa\criminal_gpt5.csv"
MAX_FILES = 9100
...
FIELDS: List[Dict[str, Any]] = [
    ...
    # Персональні дані військовослужбовця
    {
        ...
        "type": "string",
        "description": (
            "Позначення особи в рішенні (напр., 'ОСОБА_4' або ПІБ, якщо не анонімізовано)."
        ),
        "required": False
    },
    {
        ...
        "type": "string",
        "description": (
            "Відомості про народження (дата/місце), якщо наявні. Інакше — порожній рядок."
        ),
        "required": False
    },
    {
        ...
        "type": "string",
        "description": (
            "Адреса реєстрації/проживання (напр., 'АДРЕСА_1' або конкретна адреса)."
        ),
        "required": False
    },
    {
        ...
        "type": "string",
        "description": (
            "Громадянство (напр., 'громадянин України')."
        ),
        "required": False
    },
    {
        "name": "ethnicity_nationality_text",
        "type": "string",
        "description": (
            "Етнічність/національність, якщо згадується (напр., 'українець')."
        ),
        "required": False
    },
    {
        ...
        "type": "string",
        "description": (
            "Освіта (напр., 'з середньою освітою')."
        ),
        "required": False
    },
    {
        ...
        "type": "string",
        "description": (
            "Сімейний стан (напр., 'одружений/неодружений')."
        ),
        "required": False
    },
    {
        ...
        "type": "boolean",
        "description": (
            "Чи має дітей на утриманні (true/false)."
        ),
        "required": False
    },
    {
        ...
        "type": "number",
        "description": (
            "Кількість малолітніх дітей на утриманні (0, якщо не згадано)."
        ),
        "required": False
    },
    {
        ...
        "type": "string",
        "description": (
            "РНОКПП/ІПН (реєстраційний номер облікової картки платника податків), якщо згадується."
        ),
        "required": False
    },
    {
        ...
        "type": "string",
        "description": (
            "Військове звання (напр., 'солдат', 'сержант')."
        ),
        "required": False
    },
    {
        ...
        "type": "string",
        "description": (
            "Підстава проходження служби (напр., 'за призовом під час мобілізації', 'за контрактом')."
        ),
        "required": False
    },
    {
        ...
        "type": "string",
        "description": (
            "Посада/роль (напр., 'стрілець')."
        ),
        "required": False
    },
    {
        "name": "unit_chain_text",
        "type": "string",
        "description": (
            "Короткий опис підрозділу/ланцюга підпорядкування (напр., "
            "'стрілець гірсько-штурмового відділення гірсько-штурмового взводу "
            "гірсько-штурмової роти.) Тут не покажуть номер частини, він анонімізований. Тут цікавить найнижчий відомий рівенть підрозділу. Який взвод, яка рота, який батальйон, якщо відомо. Не бери номер частини."
        ),
        "required": False
    },
    {
        ...
        "type": "boolean",
        "description": (
            "Чи був раніше судимим: true = судимий, false = не судимий. "
            "Фраза 'раніше не судимого' => false."
        ),
        "required": False
    }
]
...
def build_prompts(fields: List[Dict[str, Any]], text: str) -> Tuple[str, str]:
    ...
    example = (
        ...
        '  "return_time_hhmm": "",\n'
        '  "person_label": "ОСОБА_4",\n'
        '  "birth_info": "",\n'
        '  "registered_residence": "АДРЕСА_1",\n'
        '  "citizenship": "громадянин України",\n'
        '  "ethnicity_nationality_text": "українець",\n'
        '  "education": "з середньою освітою",\n'
        '  "marital_status": "одружений",\n'
        '  "has_children": true,\n'
        '  "children_count": 2,\n'
        '  "tax_id": "НОМЕР_2",\n'
        '  "rank": "солдат",\n'
        '  "service_basis": "за призовом під час мобілізації",\n'
        '  "role_in_unit": "стрілець",\n'
        '  "unit_chain_text": "стрілець гірсько-штурмового відділення гірсько-штурмового взводу гірсько-штурмової роти військової частини НОМЕР_1",\n'
        '  "previously_convicted": false\n'
        "}\n"
    )
